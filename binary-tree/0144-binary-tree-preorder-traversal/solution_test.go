...
func TestPreorderTraversal1(t *testing.T) {
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := preorderTraversal1(slice2TreeNodes(tt.args.root)); !reflect.DeepEqual(tt.want, got) {
...
func TestPreorderTraversal2(t *testing.T) {
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := preorderTraversal2(slice2TreeNodes(tt.args.root)); !reflect.DeepEqual(tt.want, got) {
				t.Errorf("func(%v) = %v, want %v", tt.args.root, got, tt.want)
			}
		})
	}
...
func TestPreorderTraversal3(t *testing.T) {
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := preorderTraversal3(slice2TreeNodes(tt.args.root)); !reflect.DeepEqual(tt.want, got) {
				t.Errorf("func(%v) = %v, want %v", tt.args.root, got, tt.want)
			}
		})
	}
