...
func TestPostorderTraversal1(t *testing.T) {
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := postorderTraversal1(slice2TreeNodes(tt.args.root)); !reflect.DeepEqual(tt.want, got) {
...
func TestPostorderTraversal2(t *testing.T) {
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := postorderTraversal2(slice2TreeNodes(tt.args.root)); !reflect.DeepEqual(tt.want, got) {
				t.Errorf("func(%v) = %v, want %v", tt.args.root, got, tt.want)
			}
		})
	}
...
func TestPostorderTraversal3(t *testing.T) {
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := postorderTraversal3(slice2TreeNodes(tt.args.root)); !reflect.DeepEqual(tt.want, got) {
				t.Errorf("func(%v) = %v, want %v", tt.args.root, got, tt.want)
			}
		})
	}
